...
export default function AboutModal() {
    ...
    return (
        <>
            <button 
                className="border border-black bg-white hover:bg-gray-100 text-black font-medium py-1 px-3 rounded"
                    ...
                    <div className="flex items-center justify-center min-h-screen">
                        ...
                        <div className="bg-white z-10 p-6 rounded-lg shadow-xl w-11/12 max-w-2xl border-2 border-black relative">
                            ...
                            <div className="prose prose-sm max-w-none">
                                ...
                                <h4 className="text-lg font-medium mt-3">1. Private By Design</h4>
                                <p className="my-2">
                                ...
                                <p className="my-2">
                                    No sign-ups, no accounts, no complications. Just paste your code and share the link.
                                    The focus is on simplicity and speed, allowing you to share code snippets effortlessly.
                                </p>
